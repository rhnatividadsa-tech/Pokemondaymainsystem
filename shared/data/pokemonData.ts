...
export const STORE_ITEMS: StoreItem[] = [
  ...
  { name: 'Thunder Stone', price: 60, description: 'Used for Electric-type evolution', icon: '⚡', isStone: true },
  { name: 'Rare Candy', price: 40, description: 'Adds +5 bonus levels to a Pokémon', icon: '🍬', isStone: false },
];
